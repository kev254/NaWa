...
class AddExpensPage extends StatefulWidget {
  ...
  const AddExpensPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return AddExpensPageState();
  }
}

class AddExpensPageState extends State<AddExpensPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Expenses category"), backgroundColor: AppColors.blackColor,),
        body: Container(
